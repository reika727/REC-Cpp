...
{
    if(lx.check_symbol(lexicon::symbol::symid::INT))return std::make_unique<const var_difinition>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::IF))return std::make_unique<const _if_else_>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::WHILE))return std::make_unique<const _while_>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::FOR))return std::make_unique<const _for_>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::BREAK))return std::make_unique<const _break_>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::CONTINUE))return std::make_unique<const _continue_>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::RETURN))return std::make_unique<const _return_>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::OBRACE))return std::make_unique<const compound>(lx);
    else if(lx.check_symbol(lexicon::symbol::symid::SCOLON))return std::make_unique<const null_statement>(lx);
